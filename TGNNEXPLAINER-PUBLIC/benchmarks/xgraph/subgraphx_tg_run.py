...
def pipeline(config: DictConfig):
    ...
    config.models.ckpt_path = str(ROOT_DIR/'xgraph'/'models'/'ext'/f'{config.models.model_name}'/'saved_models'/f'{config.models.model_name}_{config.datasets.dataset_name}_{config.datasets.seed}_best.pth')
